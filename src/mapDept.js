...
{   
    ...
    return(
        ...
        <Link to='#' className='menu-bars' style={{zIndex:10, position: 'relative'}}>
          ...
          <ul className='nav-menu-items' >
            ...
            {selectedhouseMarker !== null && (
                ...
                <div>
                    ...
                    <p>
                        Amount of water supplied : {housecoords[selectedhouseMarker].Hquantity}
                    </p>
        ...
        {/* Modal for success message */}
            ...
            <Modal isOpen={complaintsModal} onClose={() => setComplaintsModal(false)} blockScrollOnMount={false}>
                <ModalOverlay />
                    <ModalContent className='complaintModal' >
                        {/* <ModalHeader>Success!</ModalHeader> */}
                        <ModalCloseButton style={{
                            // marginLeft:'97%',
                        position: 'relative', left: '95%', width: '5%'}} />
